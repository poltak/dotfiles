#!/usr/bin/env bash
# Script to handle my default OS X configurations.
# Extensively based upon mathiasbynens' .osx file from his dotfiles repo:
...
# Prompt for hostname for computer and set it to given name.
echo "What do you want this computer to be called?"
read name
...
# Menu bar: hide the User and Bluetooth icons
...
# This is known to cause problems in various Adobe apps :(
...
# Require password 5mins after sleep or screen saver begins
